...
use Admin\Controller\InvestmentController;
use Zend\Session\Container;

class InvestmentControllerFactory implements FactoryInterface
{
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
       ...
       return new InvestmentController($AbstractModel,$Adapter,$adminMsgsession,$EmailModel,$config_data);
    }
}
