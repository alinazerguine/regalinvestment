...
use AuthAcl\Controller\TransferController;
...
class TransferControllerFactory implements FactoryInterface
{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
       ...
       return new TransferController($AbstractModel,$Adapter,$UserModel,$front_Session,$EmailModel,$config_data,$authService);
    }
}
