...
! function(a, b) {
    ...
    function h(a) {
        ...
        return a = b.extend({}, o, a), a.buttons || (a.buttons = {}), c = a.buttons, d = f(c), g(c, function(a, e, f) {
            ...
            e.label || (e.label = a), e.className || (e.className = 2 >= d && f === d - 1 ? "btn_custom" : "btn_custom")
        }), a
    }
    ...
    var n = {
            ...
            closeButton: "<button type='button' class='bootbox-close-button close' data-dismiss='modal' aria-hidden='true'><i class='fa fa-times fs16 c-white'></i></button>",
    ...
    p.alert = function() {
        ...
        if (g(j, function(a, b) {
                k += "<button data-bb-handler='" + a + "' type='button' class='" + b.className + "'>" + b.label + "</button>", l[a] = b.callback
